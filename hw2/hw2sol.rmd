...
if (str_detect(os, "Linux")) {
  ...
  mimic_derived_path <- "C:/Users/Yingyan Wu/Documents/Dataset/mimic-iv-derived-data"
}
...
patients %>%
  ...
  geom_histogram(aes(y = ..count..), position = "identity",colour = "black", fill = "grey", bins = 74) +
...
system.time(labevents <- fread("labevents_icustays.csv.gz", nThread = 4))
